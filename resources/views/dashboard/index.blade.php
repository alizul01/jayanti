...
@section('content')
  <section>
    <img src="{{ asset('img/design/hero.png') }}" alt="circle_design" class="absolute top-0 left-10">
    ...
    <div class="flex flex-col gap-10 container mx-auto max-w-7xl py-8 relative z-0">
      <div class="grid grid-cols-1 gap-6 mx-4 md:mx-0">
      ...
      <div class="grid grid-cols-1 gap-6 md:flex md:gap-10 mx-4 md:mx-0">
