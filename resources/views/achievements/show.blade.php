...
@section('content')
  <main class="flex flex-col gap-5 px-20 py-6 bg-gray-100">
    <h1 class="font-semibold text-2xl">Detail Prestasi</h1>
    ...
    <form action="{{ route('achievements.update', $achievement) }}"
      ...
      <div>
        ...
        <input disabled type="text" id="organizer" name="organizer"
          class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full"
      ...
      <div class="flex gap-5">
        <div class="flex-1">
          ...
          <input disabled type="date" id="start_date" name="start_date"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full"
        ...
        <div class="flex-1">
          ...
          <input disabled type="date" id="end_date" name="end_date"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full"
      ...
      <div>
        ...
        <select disabled id="level_id" name="level_id"
          class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full">
      ...
      <div>
        <label for="rank_id" class="block mb-2 font-medium text-gray-900">Peringkat<span
            class="text-red-600">*</span></label>
        <select disabled id="rank_id" name="rank_id"
          class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full">
