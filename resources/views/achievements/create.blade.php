...
@section('content')
  <div class=" container mx-auto max-w-7xl py-8 relative z-0 min-h-screen">
    <div class="mx-4 flex flex-col gap-10">
      <section id="achievement-hero"
               class="bg-indigo-700 px-4 py-7 md:p-8 rounded-lg items-center flex flex-col gap-8 text-white container relative overflow-hidden">
        <div>
