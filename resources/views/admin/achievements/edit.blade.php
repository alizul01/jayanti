...
@section('content')
  <main class="bg-white p-5 relative max-h-screen overflow-x-auto shadow-md sm:rounded-lg">
    <h1 class="text-2xl font-semibold text-left text-gray-900">
      Edit Prestasi {{ $achievement->name }}
    </h1>

    <form action="{{ route('achievements.update', $achievement) }}"
          class="max-w-full my-5 flex flex-col gap-4" method="POST"
          enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div>
        <label for="username" class="block mb-2 font-medium text-sm text-gray-900">Nama</label>
      ...
      <div>
        <label for="nim" class="block mb-2 font-medium text-sm text-gray-900">NIM</label>
        <input type="text" id="nim"
               class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full"
               value="{{ Auth::user()->nim }}" readonly required>
      </div>
      <div>
        <label for="prodi" class="block mb-2 font-medium text-sm text-gray-900">Prodi</label>
        <input type="text" id="prodi"
               class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-purple-300 focus:border-purple-300 block w-full"
               value="{{ Auth::user()->studyprograms->name }}" readonly required>
      </div>
      <div>
        <label for="name" class="block mb-2 font-medium text-sm text-gray-900">Judul Kompetisi<span
      ...
      <div>
        <label for="description" class="block mb-2 font-medium text-sm text-gray-900 dark:text-white">
      ...
      <div>
        <label for="organizer" class="block mb-2 font-medium text-sm text-gray-900">Instansi Penyelenggara<span
            class="text-red-600">*</span>
        </label>
      ...
      <div>
        <label for="location" class="block mb-2 font-medium text-sm text-gray-900">Lokasi Lomba<span
            class="text-red-600">*</span>
        </label>
      ...
      <div class="flex gap-5">
        <div class="flex-1">
          <label for="start_date" class="block mb-2 font-medium text-sm text-gray-900">Tanggal Mulai Pelaksanaan<span
              class="text-red-600">*</span>
          </label>
        ...
        <div class="flex-1">
          <label for="end_date" class="block mb-2 font-medium text-sm text-gray-900">Tanggal Selesai
      ...
      <div>
        <label for="level_id" class="block mb-2 font-medium text-sm text-gray-900">Tingkat<span
      ...
      <div>
        <label for="rank_id" class="block mb-2 font-medium text-sm text-gray-900">Peringkat<span
            class="text-red-600">*</span></label>
      ...
      <div class="flex flex-col gap-5">
        <div>
          <div class="flex-1">
            <label class="block mb-2 font-medium text-sm text-gray-900" for="idea_file">
              File Ide/Karya<span class="text-yellow-300">*</span>
            </label>
            <div class="hover:bg-purple-100 p-2 rounded-lg flex flex-row gap-4">
              ...
              <a href="{{ asset('storage/' . $achievement->user_id . '/' . $achievement->id . '/idea/' . $achievement->iea_file) }}"
                 target="_blank" class="text-purple-500 hover:text-purple-700">File Sertifikat</a>
            </div>
          </div>
          <div class="flex-1">
            <label class="block mb-2 font-medium text-sm text-gray-900" for="certificate_file">
        ...
        <div>
          <div class="flex-1">
            <label class="block mb-2 font-medium text-sm text-gray-900" for="poster_file">
          ...
          <div class="flex-1">
            <label class="block mb-2 font-medium text-sm text-gray-900" for="documentation_file">
